...
import swes.swes.R;
import swes.swes.activity.SplashScreen;
...
public class  PostsMainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.fab_new_post).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PostsMainActivity.this, NewPostActivity.class));
            }
        });
    }
